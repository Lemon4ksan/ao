...
const struct helptxt helptext[] = {
  ...
  { "    --basic",
    ...
    CURLHELP_AUTH | CURLHELP_HTTP },
  { "    --bench",
    "High-performance multi-threaded benchmark load generator",
    CURLHELP_IMPORTANT | CURLHELP_CONNECTION | CURLHELP_CURL | CURLHELP_GLOBAL },
  { "    --bench-concurrency <num>",
    "Concurrent in-flight connections (alias: --concurrency, default: 500)",
    CURLHELP_CONNECTION | CURLHELP_CURL | CURLHELP_GLOBAL },
  { "    --bench-duration <time>",
    "Duration of benchmark (alias: --duration, e.g. 10s, 30s, 1m)",
    CURLHELP_CURL | CURLHELP_GLOBAL },
  { "    --bench-rate <num>",
    "Target RPS rate limit (0 = max speed)",
    CURLHELP_CONNECTION | CURLHELP_CURL | CURLHELP_GLOBAL },
  { "    --bench-requests <num>",
    "Total requests limit (alias: --requests, 0 = duration-based)",
    CURLHELP_CURL | CURLHELP_GLOBAL },
  { "    --bench-threads <num>",
    "Number of worker threads (alias: --threads, 0 = CPU cores)",
    CURLHELP_CONNECTION | CURLHELP_CURL | CURLHELP_GLOBAL },
  { "    --ca-native",
